...
<?php
	...
	tabs.addIFrameTab(menuid + 'all', { name: 'All', iframeURL: '$me?b=sreel', txtColor: '#28A9D3', txtSelectColor: '#28A9D3', tabLImage: 'images/tabs/tabl.png', tabTImage: 'images/tabs/tabt.png', tabRImage: 'images/tabs/tabr.png', extraBackdrop: '#28A9D3', borderSelect: '#fff 1px solid' } );	
