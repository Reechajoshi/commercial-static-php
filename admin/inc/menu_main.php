<script type="text/javascript"> <!--
	...
	{ 
		...
		<?php 
			echo('tabs.addIFrameTab(menuid + "Content", CUtil.mergeAssoArr( { name: "Content", iframeURL:"'.$me.'?a=cont" }, TAB_BASE_PARAMS ) );');
			
			echo('tabs.addIFrameTab(menuid + "Production House Show Reel", CUtil.mergeAssoArr( { name: "Production ShowReel", iframeURL:"'.$me.'?a=shreel" }, TAB_BASE_PARAMS ) );');
