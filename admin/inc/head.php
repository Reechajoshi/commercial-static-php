<title>Macgregor Techknowlogy</title>

<script type="text/javascript" src="jsinc.x"></script>
<?php 
	include("inc/js_helper.php");
	
?>
<link rel="stylesheet" type="text/css" href="styles/ui.css.x">
<script type="text/javascript"> <!--
	var tabprops = new Array();	
	tabprops['TAB_CONTENT'] = { txtColor: '#28A9D3', txtSelectColor: '#28A9D3', tabLImage: 'images/tabs/tabl.png', tabTImage: 'images/tabs/tabt.png', tabRImage: 'images/tabs/tabr.png', extraBackdrop: '#28A9D3', borderSelect: '#fff 1px solid' };
